...
public class GameView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    // The colors
    private static final int colorPipe = Color.parseColor("#0765F1");
    ...
    private static final float pipeWidth = 100.0f;
    ...
    private void init() {
        ...
        bitmap = Bitmap.createScaledBitmap(bitmap, 80, 70, false);
